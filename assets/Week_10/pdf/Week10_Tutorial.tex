...
\begin{tcolorbox}[colback=accentgreen!20, colframe=primarygreen, boxrule=2pt, arc=5pt]
\centering
\textbf{\Large Course Website}

All course materials available at:
\href{https://mohammadrezanarimaniucdavis.github.io/PLS120-Statistics-Lab-Materials/}{Course Website Link}

\textbf{\Large Interactive Binder Environment}

Access Week 10 lab materials:
\href{https://mybinder.org/v2/gh/MohammadrezaNarimaniUCDavis/PLS120-Statistics-Lab-Materials/binder-week10}{Week 10 Binder Link}
\end{tcolorbox}
